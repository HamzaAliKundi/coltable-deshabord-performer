        ...
        {events.map((event) => (
          ...
          >
            ...
            <div className="p-3 flex flex-col">
              ...
              <button
                onClick={() => navigate(`/messages?eventId=${event._id}&recipientId=${event?.user?._id}&recipientName=${event?.user?.name}&recipientImage=${event?.user?.logo}&eventName=${event?.title}`)}
